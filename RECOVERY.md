# Recovering untracked files lost *without* the guardian
...
> You can also print this from the CLI: `gsg recover-help`.
...
**The lesson:** snapshot before destruction. That is exactly what
`git-sync-guardian` automates — run dangerous commands through
`gsg guard -- ...` or use `gsg sync`.
